  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-sm">
        ...
        <p className="mb-6 text-sm text-slate-500">Start tracking your money in minutes</p>

        {params.error && (
          <div className="mb-4 rounded-md bg-red-50 px-3 py-2 text-sm text-red-600">{params.error}</div>
        )}
        {params.message && (
          <div className="mb-4 rounded-md bg-green-50 px-3 py-2 text-sm text-green-700">{params.message}</div>
        )}
